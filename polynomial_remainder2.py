...
def init_ifact(cap = 10**5):
  ifact2[1] = 1
  for i in xrange(2,cap):
    ifact2[i] = (mod_inv(i) * ifact2[i-1]) % p
...
#print remainder_coeff(10**13,10**12,10000,p)

print (binomial_mod(10**13,10**4,p)*binomial_mod(10**13-10**4-1,10**13-10**12,p))%p