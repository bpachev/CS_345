...
#define MAX_DC 127
//maximum wait in line for poject 3
#define MAX_WAIT 30
//maximum wait to request park entrance in project 3
#define PARK_WAIT 100
#define MAX_STRING_SIZE		127
#define MAX_ARGS			50
#define MAX_ARG_LEN 100
#define COMMAND_BUF_LEN 127
...
#define NEXT_COM(i) (i+1) % COMMAND_BUF_LEN
#define PREV_COM(i) (i) ? i - 1 : COMMAND_BUF_LEN-1

//extract tid from system queue
#define Q_TID(q,i)  q[i] >> 8
...
typedef struct							// task control block
{
	...
	int time; //task time slices left (project 5)
...
void swapTask(void);
char ** clone_argv(char** old_argv, int argc);
